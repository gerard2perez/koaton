...
module.exports = () => {
    var config = require(process.cwd()+'/config/views');
    var path = config[0];
    var opts = config[1];
        ...
        Object.assign(this, {
            render: function*(relPath, locals) {
                ...
                if (isHtml(ext) && !opts.map) {
                    ...
                    this.body = yield render(opts.layout, state);
                }
            }
        })
...
//     var view = require('../config/views');
//     var render = cons(view[0], view[1]);
//     app.use(function *(next){
//     	yield next;
//     	yield this.render('layouts/main.handlebars',{body:this.body,env_dev:process.env.NODE_ENV=="development"});
//     });
//     return require('koa-views')(view[0], view[1]);
// };
